...
namespace Ir.Persistance.Migrations
{
    ...
    [Migration("20240416141551_nullcustomeridaddition")]
    partial class nullcustomeridaddition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ir.domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ir.domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ir.domain.Entities.Lead", b =>
                {
                    b.HasOne("ir.domain.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany()
